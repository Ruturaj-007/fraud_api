...
![Overview — KPI cards, break-even strip, trend and category charts](./screenshots/img_1.png)
...
**Overview — fraud split donut and recall gauge**
![Overview — fraud split & recall](./screenshots/img_2.png)

**Transaction Review — flagged high-risk transaction with risk signals and AI explanation**
![Transaction Review — flagged transaction](./screenshots/img_3.png)

**Transaction Review — financial impact (expected loss / value protected)**
![Transaction Review — financial impact](./screenshots/img_4.png)

**Case Queue — demo and live cases**
![Case Queue](./screenshots/img_5.png)

**Model Performance — confusion matrix and fraud-vs-legit signal comparison**
![Model Performance — confusion matrix](./screenshots/img_6.png)

**Model Performance — precision-recall trade-off chart**
